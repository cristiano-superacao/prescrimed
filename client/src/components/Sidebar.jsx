...
export default function Sidebar({ onClose }) {
  ...
  const menuItems = [
    ...
    { path: '/agenda', label: 'Agenda', icon: Calendar, permission: null },
    { path: '/cronograma', label: 'Cronograma', icon: CalendarDays, permission: null },
    ...
    { path: '/estoque', label: 'Estoque', icon: Package, permission: null },
    { path: '/evolucao', label: 'Evolução', icon: Activity, permission: null },
    { path: '/financeiro', label: 'Financeiro', icon: DollarSign, permission: null },
